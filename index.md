...
You can use the [editor on GitHub](https://github.com/kanaevan/kanaevan.github.io/edit/main/index.md) to maintain and preview the content for your website in Markdown files.

Whenever you commit to this repository, GitHub Pages will run [Jekyll](https://jekyllrb.com/) to rebuild the pages in your site, from the content in your Markdown files.


Classification 问题的数据分析流程-0
...
##[Encoding Categorical Variables] 分类变量编码
++[ LightGBM 不需要进行编码]++
	...
	Method2：One-hot encoding（dummy variables）★better
		...
		缺：变量level过多会占用大量内存  → 解决：[dimension reduction] （[PCA]）
...
++注意：testing 和training里的编码要一致++
# Exploratory Data Analysis (EDA)-探索性数据分析
## 分析因变量分布状况-y Column
方法：柱状图 hist - balance or [imbalance]
## Column Types
...
## Correlations
###Pearson correlation
We can calculate the [Pearson correlation] coefficient between every x and the y using the `.corr` dataframe method.
* .00-.19 “very weak”
* .20-.39 “weak”
* .40-.59 “moderate”
* .60-.79 “strong”
...
# Feature Engineering
++[Feature Engineering is most important part of DDD], "applied machine learning is basically feature engineering." ++
...
## Polynomial features
`sklearn.preprocessing.PolynomialFeatures`[documentation]
...
++在统计模型中常见，但不怎么在machine learning中用到。++
...
++When we are creating polynomial features, we want to avoid using too high of a degree, both because the number of features scales exponentially with the degree, and because we can run into problems with [overfitting]++
##Domain knowledge features
利用与问题相关的专业知识主观进行特征工程
#Model Implementation — Baseline
##Logistic Regression
use `LogisticRegressionfrom` Scikit-Learn [documentation]
